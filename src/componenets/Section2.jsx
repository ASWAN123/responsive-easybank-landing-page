...
function Section2() {
  return (
    <div className="w-full  bg-[#F3F4F6] flex flex-col items-center  md:items-start gap-6 py-6  ">
      <div className=" w-4/5 m-auto flex flex-colyyyyyyyyyyyyyyyyyyyyyy  md:items-start gap-4  p-6 ">
        <h2 className="text-[25px] font-normal ">Why choose Easybank?</h2>
        <p className="text-[14px] text-gray-400 ">
          We leverage Open Banking to turn your bank account into your financial
          hub.<br/>Control your finances like never before.
        </p>
      </div>
      <div className="w-4/5 m-auto p-2 flex gap-4 items-center  ">
        <div className="flex gap-4  flex-col p-4  justify-center ">
