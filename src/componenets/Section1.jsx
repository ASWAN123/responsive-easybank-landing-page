    ...
    <div className='w-full min-h-screen max-h-screen bg-[#FAFAFA] relative flex overflow-hidden '>
        <div className='w-4/5 m-auto flex   flex-col-reverse md:flex-row items-center pb-6 gap-2 md:p-6 '>
            ...
            <div className='flex flex-col-reverse  md:block '>
                <img className='absolute  -top-[20%] right-0 z-[40] md:top-[-20%] md:right-[-10%]' src = "./images/image-mockups.png" alt = "desktop-image" />
                <img className='absolute  -top-[20%] left-0  scale-[2] md:scale-[1]  md:botton-0 md:left-auto md:top-[-40%] md:right-[-35%] ' src="./images/bg-intro-desktop.svg" alt="desktop-image" />
            </div>
