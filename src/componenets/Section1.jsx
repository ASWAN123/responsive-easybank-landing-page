...
function Section1() {
  return (
    <div className='w-full min-h-screen max-h-screen md:min-h-[600px] md:max-h-[600px] bg-[#FAFAFA] relative flex overflow-hidden gap-6'>
        ...
        <div className='w-4/5  max-h-screen m-auto flex justify-between  flex-col-reverse  md:flex-row items-center  gap-12   md:p-6 '>

            <div className='flex flex-col items-center text-center md:text-start md:items-start gap-6 md:w-[40%] '>
            ...
            <div className='flex flex-col-reverse  md:block  mb-12 md:mb-auto'>
